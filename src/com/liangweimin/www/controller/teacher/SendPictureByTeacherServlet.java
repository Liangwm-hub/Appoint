 ...
 * @author 梁伟民
 */
@WebServlet(name = "SendPictureByTeacherServlet", urlPatterns = "/teacher/SendPictureByTeacherServlet")
public class SendPictureByTeacherServlet extends HttpServlet {
    @Override
            ...
            try {
                ...
                if (iterator.hasNext()) {
                    ...
                    if (fileName != null && !"".equals(fileName)) {
                        ...
                        //不是图片的情况
                        if (!((Constant.JPG.equals(ext)) || (Constant.GIF.equals(ext)) || (Constant.PNG.equals(ext)))) {
                        ...
                        //封装
                        ChatMessage chatMessage = new ChatMessage(chatId, fileName, "图片", teacherName, userName, "导师", createTime);
