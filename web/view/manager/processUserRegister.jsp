...
<form id="form" action="manager/ApproveRegisterServlet" method="post">
    <table border="1" class="table table-hover">
        ...
        <tr>
            ...
            <td><a href="manager/ApproveRegisterServlet?sno=<%=u.getSno()%>">批准</a>
            </td>
            <td>
                <a href="manager/RefuseRegisterServlet?sno=<%=u.getSno()%>">驳回</a>
            </td>
        </tr>
        <%
                }
...
<nav aria-label="Page navigation">
    <ul class="pagination">
        ...
        <li>
            <a href="manager/FindRegisterByPageServlet?currentPage=<%=pb.getCurrentPage()-1%>&rows=10" aria-label="Previous">
        ...
        %>
        <li class="active"><a href="manager/FindRegisterByPageServlet?currentPage=<%=i%>&rows=10"><%=i%>
        </a></li>
        <%
        } else {
        %>
        <li><a href="manager/FindRegisterByPageServlet?currentPage=<%=i%>&rows=10"><%=i%>
        </a></li>
        <%
                }
            }
        ...
        <li>
            <a href="manager/FindRegisterByPageServlet?currentPage=<%=pb.getCurrentPage()+1%>&rows=10" aria-label="Next">
