...
<div align="center" style="white-space: pre-wrap;text-indent:2em;">
        <textarea cols="70" rows="12" readonly="readonly" style="font-size: 20px"><%=notice.getNoticeContent()%></textarea>
</div>
</pre>

<div align="center">
    <a href="manager/DownloadFileByManagerServlet?fileName=<%=notice.getFileName()%>"><h4>附属文件</h4></a>
</div>
