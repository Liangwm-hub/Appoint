...
<nav aria-label="Page navigation">
    <ul class="pagination">
        ...
        <li>
            <a href="user/SearchByKeywordsServlet?currentPage=<%=pb.getCurrentPage()-1%>&rows=5" aria-label="Previous">
        ...
        %>
        <li class="active"><a href="user/SearchByKeywordsServlet?currentPage=<%=i%>&rows=5"><%=i%>
        </a></li>
        <%
        } else {
        %>
        <li><a href="user/SearchByKeywordsServlet?currentPage=<%=i%>&rows=5"><%=i%>
        </a></li>
        <%
                }
            }
        ...
        <li>
            <a href="user/SearchByKeywordsServlet?currentPage=<%=pb.getCurrentPage()+1%>&rows=5" aria-label="Next">
