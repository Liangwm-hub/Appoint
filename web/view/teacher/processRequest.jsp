...
<form id="form" action="teacher/ProcessSelectedServlet" method="post">
    <table border="1" class="table table-hover">
        ...
        <tr>
            ...
            <td><a href="teacher/DownloadPictureServlet?num=<%=u.getNum()%>">查看图片</a>
            </td>
            <td><a href="teacher/ChatToUserServlet?userSno=<%=u.getSno()%>&teacherId=<%=u.getId()%>">进入聊天室</a>
            </td>
            <td><a href="teacher/ProcessSelectedServlet?num=<%=u.getNum()%>">批准</a>
            </td>
            <td>
                <a href="teacher/RefuseRequestByNumServlet?num=<%=u.getNum()%>">拒绝</a>
            </td>
        </tr>
        <%
                }
...
<nav aria-label="Page navigation">
    <ul class="pagination">
        ...
        <li>
            <a href="teacher/ProcessRequestServlet?currentPage=<%=pb.getCurrentPage()-1%>&rows=10" aria-label="Previous">
        ...
        %>
        <li class="active"><a href="teacher/ProcessRequestServlet?currentPage=<%=i%>&rows=10"><%=i%>
        </a></li>
        <%
        } else {
        %>
        <li><a href="teacher/ProcessRequestServlet?currentPage=<%=i%>&rows=10"><%=i%>
        </a></li>
        <%
                }
            }
        ...
        <li>
            <a href="teacher/ProcessRequestServlet?currentPage=<%=pb.getCurrentPage()+1%>&rows=10" aria-label="Next">
