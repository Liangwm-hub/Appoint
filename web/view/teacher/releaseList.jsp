...
<h4>
    <form class="form-inline" action="teacher/AppointScopeServlet" method="post">
...
<table border="1" class="table table-hover">
    ...
    <tr>
        ...
        <td><a href="teacher/QueryReleaseServlet?id=<%=u.getId()%>&appointTime=<%=u.getAppointTime()%>&place=<%=u.getPlace()%>">修改</a>
        </td>
        <td>
            <a href="teacher/DeleteReleaseServlet?id=<%=u.getId()%>&appointTime=<%=u.getAppointTime()%>&place=<%=u.getPlace()%>">删除</a>
        </td>
    </tr>
    <%
            }
...
<nav aria-label="Page navigation">
    <ul class="pagination">
        ...
        <li>
            <a href="teacher/FindReleaseByPageServlet?currentPage=<%=pb.getCurrentPage()-1%>&rows=5" aria-label="Previous">
        ...
        %>
        <li class="active"><a href="teacher/FindReleaseByPageServlet?currentPage=<%=i%>&rows=5"><%=i%>
        </a></li>
        <%
        } else {
        %>
        <li><a href="teacher/FindReleaseByPageServlet?currentPage=<%=i%>&rows=5"><%=i%>
        </a></li>
        <%
                }
            }
        ...
        <li>
            <a href="teacher/FindReleaseByPageServlet?currentPage=<%=pb.getCurrentPage()+1%>&rows=5" aria-label="Next">
